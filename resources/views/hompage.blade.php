    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <h1 class="brand"><a href="index.html">VSO</a></h1>
          <!-- navigation -->
          <nav class="pull-right nav-collapse collapse">
            <ul id="menu-main" class="nav">
              <li><a title="team" href="#about">អំពីយើង</a></li>
              <li><a title="services" href="#services">មេរៀន</a></li>
              <li><a title="works" href="#works">សកម្មភាព</a></li>
              <li><a title="blog" href="#blog">អត្ថបទអាន</a></li>
              <li><a title="contact" href="#contact">ទំនាក់ទនង</a></li>
              <li><a href="{{ route('courses') }}">ចូល</a></li>
              <li><a href="{{ route('register') }}">ចុះឈ្មោះ</a></li>
            </ul>
          </nav>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="span2 offset1 flyIn">
          <div class="people">
            <img class="team-thumb img-circle" src="img/team/1.jpg" alt="" />
            <h3>សុឃុំ ខឿន</h3>
            <p>
              ផ្នែកគណនេយ្យ
            </p>
        ...
        <div class="span2 flyIn">
          <div class="people">
            <img class="team-thumb img-circle" src="img/team/2.jpg" alt="" />
            <h3>អាន់ គន្ធា</h3>
            <p>
              វិស្វាករ កុំព្យូទ័រ
            </p>
      ...
      <div class="row">
        <div class="span3 animated-fast flyIn">
          <div class="service-box">
            <a href="{{ route('courses') }}"><img src="img/icons/grade12.png" alt="" /></a>
            <h2>ថ្នាក់ទី​ ១២</h2>
            <p>
              មេរៀនត្រៀមប្រលងសម្រាប់ប្រលងយកសញ្ញាបត្រ័ទុតិយភូមិ និងប្រលងសិស្សពូកែនានា 
            </p>
        ...
        <div class="span3 animated flyIn">
          <div class="service-box">
            <a href="{{ route('courses') }}"><img src="img/icons/grade11.png" alt="" /></a>
            <h2>ថ្នាក់ទី ១១</h2>
            <p>
              មេរៀនត្រៀម​ប្រលងប្រចាំខែ ប្រចាំឆមាស និងជាមួលដ្ឋានគ្រិះដើម្បីចូលរៀនថ្នាក់ទី ១២
            </p>
            <button>Download</button>
          </div>
        ...
        <div class="span3 animated-fast flyIn">
          <div class="service-box">
            <a href="{{ route('courses') }}"><img src="img/icons/grade10.png" alt="" /></a>
            <h2>ថ្នាក់ទី ១០</h2>
            <p>
              មេរៀនល្អៗ និងគន្លិះសំខាន់ៗដើម្បីទៅប្រលងសិស្សពូកែប្រចាំសាលា​ និងទូទាំងប្រទេស
            </p>
            <button>Download</button>
          </div>
        </div>
        <div class="span3 animated-slow flyIn">
          <div class="service-box">
            <a href="{{ route('courses') }}"><img src="img/icons/grade9.png" alt="" /></a>
            <h2>ថ្នាក់ទី ៩</h2>
            <p>
              មេរៀន និងលំហាត់ល្អៗ ដើម្បីត្រៀមប្រលងសិស្សពូកែ និងសញ្ញបត្រ័បឋមសិស្សាទុតិយភូមិ
            </p>
            <button>Download</button>
          </div>
        </div>
        ...
        <div class="span3">
          <div class="home-post">
            ...
            <div class="entry-content">
              ...
              <a href="{{ route('courses') }}" class="more">Read more</a>
            </div>
          </div>
        </div>
        <div class="span3">
